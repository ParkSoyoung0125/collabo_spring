...
public class MemberTest {
    @Autowired // 의존하고 있는 객체를 외부에서 자동주입.
    private MemberRepository memberRepository; // 기본값은 null (인터페이스와 클래스는 참조형이기 때문에 값이 들어가지않으면 null임.)
    ...
    public void insertMemberList(){
        ...
        memberRepository.save(mem01); // 데이터베이스에 인서트함.
        System.out.println("-------------------------");
